          ...
          <div class="panel-body">
            ...
            <form @submit.prevent="submit">
              <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Tulis kritik dan saran anda" v-model="form.isi_krisar"></textarea>
              </div>
              <div class="row">
                <div class="col-sm-6">
...
<script type="text/javascript">
  export default {
    ...
    methods: {
      submit () {
        this.loadingStart()
        this.$store.dispatch('putKrisar', this.form).then(response => {
          if (response.status !== 200) {
            ...
            this.success = 'Kritik dan saran telah terkirim :)'
          }
          this.loadingStop()
        })
      },
